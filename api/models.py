...
class Installer(models.Model):
    user = models.OneToOneField(User, db_index=True, on_delete=models.CASCADE, verbose_name='시공 연결된 아이디',
                                limit_choices_to={'groups__name': '시공'}, related_name='installer')
...
class Post(models.Model):
    ...
    installer = models.ForeignKey(Installer, db_index=True, null=True, blank=True, verbose_name='시공',
                                  on_delete=models.SET_NULL, help_text='시공')
